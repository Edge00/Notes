...
> ![通配符*](./images/正则-11.png)
>
> ![通配符*](./images/正则-12.png)

### 字符类取反 ^
* 使用元字符  ^ 创建 **反向类/负向类**
* 反向类的意思是不属于某类的内容
* 表达式 [^abc] 表示 **不是字符a或b或的内容**
> ![通配符*](./images/正则-13.png)
>
> ![通配符*](./images/正则-14.png)

### 范围类 -
* 表达式 [a-z] 用 - 来连接两个字符表示**从a到z的任意字符**
* 这是一个闭区间，包含 a 和 z 本身
> ![通配符*](./images/正则-15.png)
>
> ![通配符*](./images/正则-16.png)
* 在 [] 组成的类内部是 **可以连写** 的 [a-zA-Z] 表示匹配 a-z 的任意字符并且不区分大小写
> ![通配符*](./images/正则-17.png)
>
> ![通配符*](./images/正则-18.png)

### 预定义类
* 正则表达式提供 预定义类 来匹配常见的字符类
> ![通配符*](./images/正则-19.png)
> * 例如 匹配一个 **ab+数字+任意字符** 的字符串
>  * 不使用预定义类 ab[0-9][^\r\n]
>  * 使用预定义类 ab\d.
>  * 他们的效果是一样的
>
>![通配符*](./images/正则-20.png)
>
>![通配符*](./images/正则-21.png)

### 边界
* 正则表达式还提供了几个常用的边界匹配字符
>注意 当 ^ 不在 [] 内时 表示 start of line
>
>![通配符*](./images/正则-22.png)
>
>![通配符*](./images/正则-23.png)
* m 多行匹配
>![通配符*](./images/正则-24.png)

### 量词
* 例如 匹配一个连续出现**20次**数字的字符串 \d{20}
> 建议在 https://regexper.com/ 查看图形释义
>
>![通配符*](./images/正则-25.png)

### 贪婪模式
* 正则表达式会尽量多的匹配符合条件的字符
>这个表达式会以 6 匹配
>
>![通配符*](./images/正则-26.png)

### 非贪婪模式
* 让正则表达式会尽量少的匹配，一旦匹配成功就不再机继续尝试
* 只需要在量词后面加上 ? 即可
>![通配符*](./images/正则-27.png)

### 分组 group
* 例如 希望匹配字符串 Byron 连续出现三次的
* Byron{3} 会匹配 n 出现三次，不能达到预期，这时就要用到分组
* 用 () 可以达到分组的功能，使量词作用于group，即 (Byron){3}
>![通配符*](./images/正则-28.png)

### 或
* 使用 | 可以达到 或 的效果
>![通配符*](./images/正则-29.png)

### 反向引用
* 使用 $number 来反向获取原始字符串的分组内容
>![通配符*](./images/正则-30.png)

### 忽略分组
* 不希望捕获某些分组，只需要在分组内加上 ?: 就可以
>可以看到 ok 成为了 group1
>
>![通配符*](./images/正则-31.png)
